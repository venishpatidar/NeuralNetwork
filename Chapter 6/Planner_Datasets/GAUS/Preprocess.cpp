...
int n_train = 400;
int n_test =  429174; // number of points in grid @ref PlannerDatasetGenerator.ipynb Generating the decision boundary's grid of points
int input_dim = 2;
int output_dim = 1;

string X_TRAIN = "X_TRAIN_GAUS";
string Y_TRAIN = "Y_TRAIN_GAUS";
string X_TEST = "X_TEST_GAUS";
